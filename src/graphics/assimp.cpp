...
namespace bolt {
    [[nodiscard]] std::optional<Mesh> assimp_load(std::filesystem::path const &path) {
        ...
        LOG_INFO("Has Animations? %s", scene->HasAnimations() ? "TRUE" : "FALSE");
        LOG_INFO("Has Cameras?    %s", scene->HasCameras() ? "TRUE" : "FALSE");
        LOG_INFO("Has Lights?     %s", scene->HasLights() ? "TRUE" : "FALSE");
        LOG_INFO("Has Materials?  %s", scene->HasMaterials() ? "TRUE" : "FALSE");
        LOG_INFO("Has Meshes?     %s", scene->HasMeshes() ? "TRUE" : "FALSE");
        LOG_INFO("Has Textures?   %s", scene->HasTextures() ? "TRUE" : "FALSE");
